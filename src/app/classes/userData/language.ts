...
export class Language {
    public static language = 'en_GB'; // current language
     ...
     */
    public toTag(name: string): string {
     ...
     * @param tag the ISO tag of the language
     */
    public toName(tag: string): string {
